...
})(this, function(__WEBPACK_EXTERNAL_MODULE_19__, __WEBPACK_EXTERNAL_MODULE_47__, __WEBPACK_EXTERNAL_MODULE_48__) {
...
var endOfLine = __webpack_require__(48).EOL;
...
var argv = __webpack_require__(99).argv;
...
var AutoIncreaseVersion = function () {
  ...
  (0, _createClass3.default)(AutoIncreaseVersion, [{
    ...
    value: function closePackageFile(newVersion, build) {
      var _this2 = this;
      ...
      _fs2.default.writeFile(_path2.default.resolve(this.context.config.PACKAGE_JSON_PATH), (0, _stringify2.default)(this.packageFile, null, 4), function (err) {
        ...
        if (build) {
          _this2.context.build = build;
          _log2.default.info('fix version ' + build);
        }
        _this2.resolve();
        return true;
      });
    ...
    key: 'fix',
    value: function fix() {
      var build = Number(this.packageFile.build) + 1;
      var newVersion = this.packageFile.version;
        ...
        for (var basename in compilation.assets) {
          ...
          if (_this.context.config.componentsOptions.InjectByTag.fileRegex.test(basename)) {
            var _ret = function () {
              ...
              var modFile = originalSource.replace(InjectByTag.AIVTagRegexp, function (tag) {
                // handle version
                ...
                // handle FIX version
                tag = tag.replace(/(\{)(fix-version)(\})/g, function () {
                  return _this.context.build;
                });

                // handle date
                tag = tag.replace(/(\{)(date)(\})/g, function () {
                  return (0, _dateformat2.default)(new Date(), _config2.default.componentsOptions.InjectByTag.dateFormat);
                });
...
InjectByTag.AIVTagRegexp = /(\[AIV])(([a-zA-Z{} :;!()_@\-"'\\\/])+)(\[\/AIV])/g;
...
var ansiStyles = __webpack_require__(50);
var stripAnsi = __webpack_require__(104);
...
module.exports = !__webpack_require__(5) && !__webpack_require__(33)(function () {
...
var minimist = __webpack_require__(98);
var wordwrap = __webpack_require__(100);
